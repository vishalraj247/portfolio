    ...
    workTimeline: [
        {
            ...
            icon: <DiCodeigniter/>,
            tags: ["Data Science", "Research", "CoAuthor Dataset", "Keystroke-level Data", "GPT-3", "Literature Review", "Data
                    Visualisation", "User Behavior Metrics", "Python", "Natural Language Processing (NLP)", "Data Storytelling",
        ...
        },
        {
            ...
            such as data analysis, Python programming, statistical analysis, and data visualization. I also became adept at using tools 
            like Jupyter Notebook, GitHub, and Watson Studio.",
